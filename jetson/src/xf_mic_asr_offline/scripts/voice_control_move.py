...
# @data:2023/11/18
# @author:aiden
# 语音控制移动(Voice-controlled movement)
import os
import json
import math
import time
...
MAX_SCAN_ANGLE = 240  # 激光的扫描角度,去掉总是被遮挡的部分degree(Laser scan angle, excluding the parts that are always obstructed, in degrees)
CAR_WIDTH = 0.4  # meter
