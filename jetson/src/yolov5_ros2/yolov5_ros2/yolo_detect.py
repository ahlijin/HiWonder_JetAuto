...
class YoloV5Ros2(Node):
    def __init__(self):
        ...
        self.declare_parameter("image_topic", "/usb_cam/rgb/image_raw", ParameterDescriptor(
            name="image_topic", description="Image topic, default: /depth_cam/rgb/image_raw"))
    ...
    def image_callback(self, msg: Image):
        ...
        for index in range(len(categories)):
            ...
            if self.start:
                ...
                time.sleep(0.01)
        if len(categories) == 0:
             self.object_pub.publish(ObjectsInfo())
